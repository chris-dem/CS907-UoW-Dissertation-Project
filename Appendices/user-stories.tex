...
will highlight the node in yellow as seen in figure \ref{fig:app:node-hover}.
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.7\linewidth]{Appendices/user-story-node-add-invalid-arity.png}
