...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item \textit{Crossover Rejuvenate}: Closely similar to the $(\mu + \lambda)$-evolutionary strategy \cite{baeck_EvolutionaryComputation1_2018}, where
        we use the best performing parent genes.
    \end{enumerate}
...
\begin{figure}
    ...
    \caption{Image source and description \cite{wychowaniec_2021}}
