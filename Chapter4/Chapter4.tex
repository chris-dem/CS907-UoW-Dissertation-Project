...
with respect to the number of backtracking calls.
We can observe that the
premature cancellations and the value set reductions allow us to keep a low number
of calls despite the graph size. We will provide a list of the solutions in the appendix \ref{}.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.3\linewidth]{Appendices/circuit-solutions/small-circuit-1.png}
    \caption{Small Circuit example}
    \label{fig:chap-4:small-circuit}

\end{figure}
\begin{figure}[htbp]
    \includegraphics[width=0.3\linewidth]{Appendices/circuit-solutions/bit-gen-1.png}
    \caption{Bit Generator}
    \label{fig:chap-4:bit-gen}
\end{figure}
\begin{figure}[htbp]
    \includegraphics[width=0.3\linewidth]{Appendices/circuit-solutions/complex-1.png}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        Complex circuit \ref{fig:chap-4:complex}      & 13                                              & 3                                                         \\
    \end{tabular}
