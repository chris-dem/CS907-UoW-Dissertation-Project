...
We mainly highlight directions: \textbf{HF-PPAD} in  \textbf{PPAD}
...
showed that as long as our gate set consits of the \textsc{Purify} gate and \textsc{NOR} or \textsc{NAND}
...
to find a solution. We argue that there may exists gates that could result in 
a better combinatorial nature and therefore assist in the resolution of our conjectures.
...
to find the maximal element in a poset of functions of $\mathcal{C} \to \mathbb{T}$. We leave this as integral evidence
