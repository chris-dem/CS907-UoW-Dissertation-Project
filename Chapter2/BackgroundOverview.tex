...
with search problems and \textit{Kleene logic}. %% TODO 
...
which takes advantage of the combinatorial fact that if there exists an unbalanced node in a directed graph, %% TODO Lio disgusting
...
We will explore the above algebra in greater depth in section \ref{subsect:chap-2:kleene}. %%TODO
...
\begin{enumerate}%% TODO
    ...
    \item $\textbf{\#P}$ is a formal system that is highly flexible.
\end{enumerate}
