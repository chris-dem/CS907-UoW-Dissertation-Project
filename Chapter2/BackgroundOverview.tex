...
The goal of the problem is to assign every problem with a value such that the assignment is correct up to a
...
From the figure we can observe that for several \textbf{PPAD}-complete, \textbf{CLS} and
