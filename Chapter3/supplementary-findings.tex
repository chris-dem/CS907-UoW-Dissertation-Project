...
Lastly in our appendix we demonstrate how one can simplify the \textit{PureCircuit}
problem in order to find parsimonious reductions to \textit{EndOfLine}
problem. We mainly demonstate, how certain conditions such as the cyclicity
of \textit{PureCircuit} or nature of \textit{Purify} can affect the
counting complexity of the problem.
