...
The above problem exploits the fact that $F$ is \textit{natural} since that implies
that $F$ is monotone with respect to the partially ordered set $(\mathbb{T}^n, \preceq)$.
We illustrate how this results in a parsimonious reduction between \textit{PureCircuit}
...
how we can relate \textit{PureCircuit}
with ATMs
