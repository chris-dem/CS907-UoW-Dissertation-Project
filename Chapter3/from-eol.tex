...
Clearly we can observe that by the above connstruction of edge removal, all \textit{EndOfLine} problems
...
\begin{proof}
    ...
    \begin{figure}[h!]
        ...
        \caption{Snake Embedding technique view between the folded dimension $j$ and the new dimension. The $x$-axis denotes the folded
