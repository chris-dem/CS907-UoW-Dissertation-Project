...
\begin{proof}
    ...
    all $u^i \in M^1_n$, otherwise that would imply that there exists a $(n-1)$-subspace that also covers all the labels.
...
$\forall v\in V_n: \textit{deg}(v) \in \{(1,0), (0,0), (0,1)\}$.
