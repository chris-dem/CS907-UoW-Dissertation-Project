This section explores the approaches and findings uncovered while
...
We therefore make use of topological problems such that resolutions of our kleene input
...
et al. \cite{deligkas_PureCircuitTightInapproximability_2024} to show \textit{PureCircuit} is \textbf{PPAD}-hard.
...
Following the same process for our second objective, we demonstrated how to reduce \textit{SourceOrExcess}
...
observations on the combinatorial nature of the problems that can be created
as well as important problems to analyse for a full \textit{PureCircuit} Cook-Levin type theorem.
Lastly we demonstrate how we can relate to \textit{Tarski} with \textit{Kleene theory} and
